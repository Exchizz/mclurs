...
struct arg_int64* arg_int640(const char* shortopts, const char* longopts, const char *datatype,
                             const char *glossary);

struct arg_int64* arg_int641(const char* shortopts, const char* longopts, const char *datatype,
                             const char *glossary);

struct arg_int64* arg_int64n(const char* shortopts, const char* longopts, const char *datatype,
